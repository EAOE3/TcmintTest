        ...
        for (EthLog.LogResult logResult : logs) {
            try {
                ...
                if (log.getTopics().get(0).equalsIgnoreCase("0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef")) {
                    ...
                    Settings.tmt.transfer(new ByteArrayWrapper(Hex.decode(from)), to, amount);
                }
                //Deposit
                    ...
                    Settings.tmt.deposit(userAddress, amount);
                ...
                //LockForWithdrawal
                    ...
                    Settings.tmt.lockInPreparationForWithdrawal(userAddress, amount);
                ...
                //UnlockFromWithdrawal
                    ...
                    Settings.tmt.unlockFromWithdrawal(userAddress, amount);
                ...
                //Withdraw
                    ...
                    Settings.tmt.completeWithdrawal(userAddress, amount);
