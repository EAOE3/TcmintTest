...
//                if (w == null) return getFail("message", "Invalid User");
                ...
                Response r = OWeb3j.sendScTxn(Settings.web3j, Settings.getMotherWalletCredentials(), Settings.chainId, collectionAddress, Settings.getGasPrice(), BigInteger.ZERO, "buy", new Address(usersAddress), new DynamicArray<>(Utf8String.class, ticketTypes), new DynamicArray<>(Uint256.class, amount), new DynamicArray(Utf8String.class, seatNumber));
